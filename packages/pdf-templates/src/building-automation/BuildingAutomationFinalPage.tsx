      ...
      <div style={{ padding: "14mm 16mm", height: "297mm", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", flex: 1 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" as any, gap: "10px" }}>
            {/* Why Octonics */}
            <div style={{ background: "linear-gradient(135deg,#0c2340,#0c3560)", borderRadius: "10px", padding: "12px" }}>
              <div style={{ color: "#06b6d4", fontSize: "8.5px", fontWeight: "700", letterSpacing: "1px", marginBottom: "7px", fontFamily: "'Montserrat', sans-serif" }}>⭐ WHY OCTONICS INNOVATIONS</div>
              ...
              <div style={{ display: "flex", flexDirection: "column" as any, gap: "4px" }}>
                {WHY_POINTS.map((p, i) => (
                  <div key={i} style={{ display: "flex", gap: "5px", alignItems: "flex-start" }}>
                    <div style={{ width: "12px", height: "12px", borderRadius: "50%", background: "#0369a1", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "1px" }}>
            ...
            <div style={{ background: "#fffbeb", border: "1px solid #fbbf24", borderRadius: "10px", padding: "10px" }}>
              <div style={{ fontSize: "8px", fontWeight: "700", color: "#92400e", marginBottom: "6px", letterSpacing: "0.5px" }}>📋 GENERAL NOTES</div>
            ...
            {/* Commercial terms */}
            {paymentTerms && (
              <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: "8px", padding: "8px", borderLeft: "3px solid #0369a1" }}>
                <div style={{ fontSize: "7px", fontWeight: "700", color: "#0369a1", letterSpacing: "1px", marginBottom: "3px" }}>PAYMENT TERMS</div>
            ...
            {terms && terms.length > 0 && (
              <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: "8px", padding: "10px" }}>
                <div style={{ fontSize: "8px", fontWeight: "700", color: "#0f172a", marginBottom: "5px" }}>TERMS & CONDITIONS</div>
                <div style={{ display: "flex", flexDirection: "column" as any, gap: "3px", maxHeight: "70px", overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" as any, gap: "10px" }}>
            ...
            <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: "10px", padding: "14px", flex: 1 }}>
              ...
              <div style={{ marginBottom: "12px" }}>
                ...
                <div style={{ marginBottom: "8px" }}>
                  ...
                  <div style={{ borderBottom: "1px solid #cbd5e1", height: "32px", background: "#f8fafc", borderRadius: "3px" }} />
                </div>
                <div>
            ...
            <div style={{ background: "#f8fafc", borderRadius: "12px", border: "1px solid #e2e8f0", position: "relative", overflow: "hidden", marginBottom: "16px" }}>
              <div style={{ position: "absolute", left: 0, top: 0, bottom: 0, width: "4px", background: "#06b6d4" }} />
              ...
              <div style={{ padding: "12px 14px 12px 18px", display: "flex", gap: "14px", alignItems: "center" }}>
                <div style={{ background: "white", padding: "6px", borderRadius: "8px", flexShrink: 0, border: "1px solid #cbd5e1", boxShadow: "0 2px 6px rgba(0,0,0,0.05)" }}>
                  <QRCodeSVG value={verifyUrl} size={54} level="H" fgColor="#0c2340" />
                </div>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px", marginBottom: "6px" }}>
                    <div>
                      ...
                      <div style={{ color: "#06b6d4", fontSize: "10px", fontWeight: "700", fontFamily: "'Courier New', Courier, monospace" }}>{proposalReference || "—"}</div>
                    </div>
                    <div>
            ...
            {/* Company footer bar */}
            <div style={{ background: "linear-gradient(135deg,#0c2340,#0c3560)", borderRadius: "10px", padding: "14px", marginTop: "auto" }}>
              ...
              <div>
                ...
                <div style={{ color: "#06b6d4", fontSize: "7px", lineHeight: "1.4" }}>

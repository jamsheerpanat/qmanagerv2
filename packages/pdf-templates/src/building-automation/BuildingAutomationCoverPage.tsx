  ...
  >
    ...
    <div
      style={{
        ...
        inset: 0,
        background:
          "linear-gradient(150deg, rgba(4,8,15,0.97) 0%, rgba(6,20,60,0.85) 55%, rgba(4,8,15,0.97) 100%)",
      }}
    />
    <div
      style={{
        ...
        right: 0,
        height: "50%",
        background: "linear-gradient(to top, #04080f 0%, transparent 100%)",
      }}
    />
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
          ...
          <div style={{ textAlign: "right" }}>
            ...
            >
              {proposalReference || "OC-BA-2025-0001"}
            </div>
      ...
      >
        ...
        >
          BUILDING
          <br />
          <span style={{ color: "#06b6d4" }}>AUTOMATION</span>
          <br />
          PROPOSAL
        </h1>
        ...
        >
          A centralized intelligent building solution designed for efficiency,
          control, monitoring, energy optimization, and operational excellence.
        </p>
        ...
        {projectName && (
          ...
          >
            ...
            {projectLocation && (
              <div
                style={{ color: "#06b6d4", fontSize: "9px", marginTop: "2px" }}
              >
                📍 {projectLocation}
              </div>
            )}

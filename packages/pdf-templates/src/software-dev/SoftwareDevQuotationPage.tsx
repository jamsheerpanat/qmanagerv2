...
export const SoftwareDevQuotationPage = ({ items, subtotal, discount, tax, grandTotal, currency = "KWD" }: any) => {
  ...
  return (
    <div className="pdf-page" style={{ fontFamily: "'Inter', 'Montserrat', sans-serif", background: "white" }}>
      <div style={{ padding: "14mm 16mm", height: "297mm", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ width: "60px", height: "3px", background: `linear-gradient(90deg,${accent},#818cf8)`, borderRadius: "2px", marginBottom: "16px" }} />
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "8px" }}>
            <thead>
              <tr style={{ background: accentGrad, color: "white" }}>
                ...
                <th style={{ padding: "10px 8px", textAlign: "left", fontWeight: "700", letterSpacing: "0.8px", fontSize: "7px", textTransform: "uppercase", width: "30%" }}>Item / Service</th>
                ...
                <th style={{ padding: "10px 8px", textAlign: "center", fontWeight: "700", letterSpacing: "0.8px", fontSize: "7px", textTransform: "uppercase", width: "10%" }}>Module</th>
                  ...
                  <tr key={idx} style={{ background: isEven ? "white" : "#f8fafc", borderBottom: "1px solid #f1f5f9" }}>
                    ...
                    <td style={{ padding: "9px 8px", fontWeight: "600", color: "#0f172a", fontSize: "8px" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                        ...
                        <div>
                          <div style={{ lineHeight: "1.3" }}>{item.sectionTitle || item.description?.substring(0, 36)}</div>
                    ...
                    <td style={{ padding: "9px 8px", textAlign: "center", color: "#6366f1", fontSize: "7px", fontWeight: "600" }}>{item.brand || item.category || "—"}</td>
                    ...
                    <td style={{ padding: "9px 8px", textAlign: "right", color: "#475569", fontSize: "8px", fontFamily: "'Inter', monospace" }}>{fmt(item.unitPrice)}</td>
                    <td style={{ padding: "9px 8px", textAlign: "right", fontWeight: "700", color: "#0f172a", fontSize: "8.5px", fontFamily: "'Inter', monospace" }}>{fmt(lineTotal)}</td>
                  </tr>
                );
              })}
              {(!items || items.length === 0) && (
                <tr><td colSpan={7} style={{ padding: "30px", textAlign: "center", color: "#94a3b8", fontSize: "9px" }}>No items defined for this quotation.</td></tr>
              )}
            </tbody>
          </table>
        </div>
          ...
          <div style={{ minWidth: "260px", maxWidth: "280px" }}>
            ...
            <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: "12px", overflow: "hidden", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 14px", background: accentGrad }}>
                ...
                <span style={{ fontSize: "14px", fontWeight: "800", color: accentHighlight, fontFamily: "'Montserrat', sans-serif" }}>{fmt(grandTotal)} <span style={{ fontSize: "8px", fontWeight: "600" }}>{currency}</span></span>
              </div>
            </div>
          </div>
        </div>

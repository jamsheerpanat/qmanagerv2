...
const METHODOLOGY = [
  { step: "01", title: "Requirement Review", desc: "We review the client's requirement, business process, workflow, users, reports, and technical expectations." },
  { step: "02", title: "Solution Design", desc: "We prepare the system architecture, UI/UX direction, database plan, user roles, workflow, and module structure." },
  { step: "03", title: "Development", desc: "The approved software is developed using a structured and maintainable development approach." },
  { step: "04", title: "Testing & QC", desc: "The system is tested for functionality, usability, security, performance, and data accuracy." },
  { step: "05", title: "Deployment", desc: "The application is deployed to the approved hosting, server, or cloud environment." },
  { step: "06", title: "Training & Handover", desc: "Users are trained to operate the system, and basic documentation is provided where applicable." },
  { step: "07", title: "Support", desc: "Post-delivery support will be provided as per the agreed support contract." },
];
...
export const SoftwareDevFinalPage = ({
  terms, paymentTerms, validityPeriod, deliveryTimeline,
  customerName, qrVerificationUrl, proposalReference, proposalDate,
}: any) => {
    ...
    <div className="pdf-page" style={{ fontFamily: "'Inter', 'Montserrat', sans-serif", background: "#f8fafc" }}>
      <div style={{ padding: "14mm 16mm", height: "297mm", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ marginBottom: "10px" }}>
          <span style={{ fontSize: "7px", fontWeight: "700", letterSpacing: "2px", color: "#6366f1", textTransform: "uppercase", background: "#eef2ff", padding: "3px 10px", borderRadius: "4px" }}>Page 4 — Terms & Acceptance</span>
        </div>

        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", flex: 1 }}>
          {/* Left column */}
          <div style={{ display: "flex", flexDirection: "column" as any, gap: "9px" }}>
            {/* Why Octonics */}
            <div style={{ background: "linear-gradient(135deg,#1e1b4b,#312e81)", borderRadius: "10px", padding: "11px" }}>
              <div style={{ color: "#a5b4fc", fontSize: "8.5px", fontWeight: "700", letterSpacing: "1px", marginBottom: "7px", fontFamily: "'Montserrat', sans-serif" }}>⭐ WHY OCTONICS INNOVATIONS</div>
              <p style={{ color: "#94a3b8", fontSize: "7.5px", lineHeight: "1.5", marginBottom: "7px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column" as any, gap: "3px" }}>
                {WHY_POINTS.map((p, i) => (
                  <div key={i} style={{ display: "flex", gap: "5px", alignItems: "flex-start" }}>
                    <div style={{ width: "11px", height: "11px", borderRadius: "50%", background: "#4f46e5", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "1px" }}>
                      <span style={{ color: "white", fontSize: "6px", fontWeight: "700" }}>✓</span>
                    </div>
                    <span style={{ fontSize: "7.5px", color: "#c7d2fe", lineHeight: "1.4" }}>{p}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: "10px", padding: "10px" }}>
              <div style={{ fontSize: "8px", fontWeight: "700", color: "#1e1b4b", marginBottom: "8px", fontFamily: "'Montserrat', sans-serif" }}>🔄 IMPLEMENTATION METHODOLOGY</div>
              <div style={{ display: "flex", flexDirection: "column" as any, gap: "5px" }}>
                {METHODOLOGY.map((m) => (
                  <div key={m.step} style={{ display: "flex", gap: "7px", alignItems: "flex-start" }}>
                    <div style={{ minWidth: "20px", height: "20px", borderRadius: "5px", background: "linear-gradient(135deg,#4f46e5,#7c3aed)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                      <span style={{ fontSize: "7px", fontWeight: "800", color: "white" }}>{m.step}</span>
                    </div>
                    <div>
                      <div style={{ fontSize: "8px", fontWeight: "700", color: "#1e1b4b" }}>{m.title}</div>
                      <div style={{ fontSize: "7px", color: "#64748b", lineHeight: "1.4" }}>{m.desc}</div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div style={{ display: "flex", flexDirection: "column" as any, gap: "10px" }}>
            ...
            <div style={{ background: "linear-gradient(135deg,#1e1b4b,#312e81)", borderRadius: "10px", padding: "14px", marginTop: "auto" }}>
              ...
              <div>
                ...
                <div style={{ color: "#a5b4fc", fontSize: "7px", lineHeight: "1.4" }}>

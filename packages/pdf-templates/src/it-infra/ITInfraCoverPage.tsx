  ...
  >
    <div
      style={{
        position: "absolute",
        inset: 0,
        backgroundImage: "url('/it-infra-cover.jpg')",
    ...
    <div
      style={{
        ...
        inset: 0,
        background:
          "linear-gradient(150deg, rgba(5,10,15,0.97) 0%, rgba(5,25,55,0.88) 55%, rgba(5,10,15,0.97) 100%)",
      }}
    />
    <div
      style={{
        ...
        right: 0,
        height: "45%",
        background: "linear-gradient(to top, #050a0f 0%, transparent 100%)",
      }}
    />
    {/* Steel-blue top bar */}
    <div
      style={{
        ...
        height: "4px",
        background:
          "linear-gradient(90deg, #0369a1, #38bdf8, #0ea5e9, #38bdf8, #0369a1)",
      }}
    />
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "right" }}>
          ...
          >
            {proposalReference || "OC-IT-2025-0001"}
          </div>
            ...
            <React.Fragment key={item.label}>
              <div
                style={{
                  ...
                  borderRight:
                    i < 6 ? "none" : "1px solid rgba(56,189,248,0.18)",
                  borderRadius:
                    i === 0 ? "6px 0 0 6px" : i === 6 ? "0 6px 6px 0" : "0",
                }}
              >
      ...
      >
        ...
        >
          IT
          <br />
          <span style={{ color: "#38bdf8" }}>INFRASTRUCTURE</span>
          <br />
          PROPOSAL
        </h1>
        <div
        ...
        >
          A secure, reliable, and scalable IT infrastructure solution designed
        ...
        {projectName && (
          ...
          >
            ...
            {projectLocation && (
              <div
                style={{ color: "#38bdf8", fontSize: "9px", marginTop: "2px" }}
              >
                📍 {projectLocation}
              </div>
            )}

...
const InnerPageHeader = ({ pageTitle }: { pageTitle?: string }) => (
  ...
  >
    ...
    <div style={{ textAlign: "right" }}>
      <div
        style={{ fontSize: "7px", color: "#94a3b8", letterSpacing: "1.2px" }}
      >
...
const InnerPageFooter = ({ pageNum }: { pageNum?: number }) => (
  ...
  >
    <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
      <img
        src="/octonics-logo.png"
        style={{ height: "10px", objectFit: "contain", opacity: 0.5 }}
      />
      <span style={{ fontSize: "6.5px", color: "#94a3b8" }}>
    ...
    <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
      ...
      />
      {pageNum && (
        <span style={{ fontSize: "8px", color: "#1a56db", fontWeight: "700" }}>
          {pageNum}
        </span>
      )}
    </div>

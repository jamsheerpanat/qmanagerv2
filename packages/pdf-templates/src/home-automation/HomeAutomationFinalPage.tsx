...
export const HomeAutomationFinalPage = ({
  ...
  return (
    <div className="pdf-page" style={{ fontFamily: "'Inter', 'Montserrat', sans-serif", background: "#f8fafc" }}>
      <div style={{ padding: "14mm 16mm", height: "297mm", display: "flex", flexDirection: "column", gap: "0" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", flex: 1 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {/* Why Octonics */}
            <div style={{ background: "linear-gradient(135deg,#0f172a,#1e3a5f)", borderRadius: "10px", padding: "12px" }}>
              <div style={{ color: "#60a5fa", fontSize: "9px", fontWeight: "700", letterSpacing: "1px", marginBottom: "8px", fontFamily: "'Montserrat', sans-serif" }}>
                ⭐ WHY OCTONICS INNOVATIONS
              </div>
              <p style={{ color: "#94a3b8", fontSize: "8px", lineHeight: "1.5", marginBottom: "8px" }}>
                Octonics Innovations is a Kuwait-based technology solutions company delivering smart automation, software development, IT infrastructure, surveillance, access control, data solutions, and intelligent business systems.
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                {WHY_POINTS.map((p, i) => (
                  <div key={i} style={{ display: "flex", gap: "5px", alignItems: "flex-start" }}>
                    <div style={{ width: "12px", height: "12px", borderRadius: "50%", background: "#1a56db", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "1px" }}>
                      <span style={{ color: "white", fontSize: "7px", fontWeight: "700" }}>✓</span>
                    </div>
                    <span style={{ fontSize: "8px", color: "#cbd5e1", lineHeight: "1.4" }}>{p}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* General Notes */}
            <div style={{ background: "#fffbeb", border: "1px solid #fbbf24", borderRadius: "10px", padding: "10px" }}>
              <div style={{ fontSize: "8px", fontWeight: "700", color: "#92400e", marginBottom: "6px", letterSpacing: "0.5px" }}>
                📋 GENERAL NOTES
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: "3px" }}>
                {GENERAL_NOTES.map((n, i) => (
                  <div key={i} style={{ display: "flex", gap: "4px", alignItems: "flex-start" }}>
                    <span style={{ color: "#d97706", fontSize: "8px", flexShrink: 0, marginTop: "1px" }}>•</span>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "6px" }}>
              {paymentTerms && (
                <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: "8px", padding: "8px", borderLeft: "3px solid #1a56db" }}>
                  <div style={{ fontSize: "7px", fontWeight: "700", color: "#1a56db", letterSpacing: "1px", marginBottom: "3px" }}>PAYMENT TERMS</div>
                  <div style={{ fontSize: "8px", color: "#334155", lineHeight: "1.5" }}>{paymentTerms}</div>
                </div>
              )}
              {validityPeriod && (
                <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: "8px", padding: "8px", borderLeft: "3px solid #10b981" }}>
              ...
              {deliveryTimeline && (
                <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: "8px", padding: "8px", borderLeft: "3px solid #f59e0b" }}>
            ...
            {terms && terms.length > 0 && (
              <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: "8px", padding: "10px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "4px", maxHeight: "80px", overflow: "hidden" }}>
                  {terms.map((t: any, i: number) => (
                    <div key={i} style={{ fontSize: "7.5px", color: "#475569", lineHeight: "1.4" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: "10px", padding: "14px" }}>
              <div style={{ fontSize: "9px", fontWeight: "700", color: "#0f172a", marginBottom: "12px", fontFamily: "'Montserrat', sans-serif" }}>
                ✍️ SIGNATURE & ACCEPTANCE
              </div>
              <p style={{ fontSize: "8px", color: "#64748b", lineHeight: "1.5", marginBottom: "14px" }}>
              ...
              <div style={{ marginBottom: "14px" }}>
                <div style={{ fontSize: "7px", color: "#94a3b8", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "3px" }}>Prepared For</div>
                <div style={{ fontSize: "10px", fontWeight: "700", color: "#0f172a", marginBottom: "10px" }}>
                  {customerName || "___________________________"}
                </div>

                <div style={{ marginBottom: "8px" }}>
                  <div style={{ fontSize: "7px", color: "#94a3b8", marginBottom: "2px" }}>Customer Name</div>
                  <div style={{ borderBottom: "1px solid #cbd5e1", height: "20px", background: "#f8fafc", borderRadius: "3px" }} />
                </div>
                <div style={{ marginBottom: "8px" }}>
                  <div style={{ fontSize: "7px", color: "#94a3b8", marginBottom: "2px" }}>Signature</div>
                  <div style={{ borderBottom: "1px solid #cbd5e1", height: "30px", background: "#f8fafc", borderRadius: "3px" }} />
                </div>
                <div>
                  <div style={{ fontSize: "7px", color: "#94a3b8", marginBottom: "2px" }}>Date</div>
                  <div style={{ borderBottom: "1px solid #cbd5e1", height: "20px", background: "#f8fafc", borderRadius: "3px" }} />
                </div>
              </div>
              ...
              <div style={{ borderTop: "1px dashed #e2e8f0", paddingTop: "10px", marginTop: "4px" }}>
                <div style={{ fontSize: "7px", color: "#94a3b8", marginBottom: "6px" }}>Company Stamp / Seal (if applicable)</div>
                <div style={{ height: "40px", border: "1px dashed #cbd5e1", borderRadius: "6px", background: "#f8fafc" }} />
              </div>
            </div>

            {/* Next-Gen Verification & Tracking Panel */}
            <div style={{ background: "#f8fafc", borderRadius: "12px", border: "1px solid #e2e8f0", position: "relative", overflow: "hidden", marginBottom: "16px" }}>
              <div style={{ position: "absolute", left: 0, top: 0, bottom: 0, width: "4px", background: "#1a56db" }} />
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px", marginBottom: "6px" }}>
                    <div>
                      ...
                      <div style={{ color: "#1a56db", fontSize: "10px", fontWeight: "700", fontFamily: "'Courier New', Courier, monospace" }}>{proposalReference || "—"}</div>
                    </div>
                    <div>
                  ...
                  <div style={{ fontSize: "6px", color: "#64748b", lineHeight: "1.4" }}>
                    Scan QR code to authenticate document via QManager secure ledger.
                  </div>
                  <div style={{ fontSize: "5.5px", color: "#94a3b8", marginTop: "2px", wordBreak: "break-all" as any }}>
                    {verifyUrl}
                  </div>
                </div>
              </div>
            ...
            <div style={{ background: "linear-gradient(135deg,#0f172a,#1e3a5f)", borderRadius: "10px", padding: "14px", marginTop: "auto" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "10px", borderBottom: "1px solid rgba(255,255,255,0.1)", paddingBottom: "10px" }}>
                <img src="/octonics-logo.png" alt="Octonics" style={{ height: "22px", width: "auto", objectFit: "contain", filter: "brightness(0) invert(1)" }} />
                <div style={{ display: "flex", gap: "6px" }}>
                  <img src="/knx-partner-logo.jpg" alt="KNX Partner" style={{ height: "18px", width: "auto", objectFit: "contain", opacity: 0.9, background: "white", padding: "2px 3px", borderRadius: "3px" }} />
                  <img src="/iso-certification.gif" alt="ISO" style={{ height: "18px", width: "auto", objectFit: "contain", opacity: 0.9, background: "white", padding: "2px 3px", borderRadius: "3px" }} />
                </div>
              </div>
              <div>
                <div style={{ color: "white", fontSize: "9.5px", fontWeight: "700", marginBottom: "3px", textTransform: "uppercase", letterSpacing: "0.5px" }}>Octonics Innovations</div>
                <div style={{ color: "#60a5fa", fontSize: "7px", lineHeight: "1.4" }}>

    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="md:col-span-1 space-y-1">
          ...
          >
            <Palette className="w-4 h-4 mr-2" /> Branding & PDF
          </Button>
          <Button
          ...
          >
            <Mail className="w-4 h-4 mr-2" /> Email Integration
          </Button>
          <Button variant="ghost" className="w-full justify-start">
            <Bell className="w-4 h-4 mr-2" /> Notifications
          </Button>
          <Button variant="ghost" className="w-full justify-start">
            <HardDrive className="w-4 h-4 mr-2" /> Storage (MinIO)
          </Button>
          <Button
          ...
          {activeTab === "company" && (
            <Card className="shadow-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Main company details used in documents and portal.
                </CardDescription>
              </CardHeader>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2">
                    ...
                    <Input
                      ...
                      placeholder="123 Business Avenue, Tech District, Dubai, UAE"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">
          ...
          {activeTab === "branding" && (
            <Card className="shadow-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Configure how your documents appear to customers.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2">
                    ...
                    <div className="flex gap-2 items-center">
                      <Input
                        ...
                        value={companyData.brandColor || "#3B82F6"}
                        onChange={(e) =>
                          setCompanyData({
                            ...companyData,
                  ...
                  <div className="col-span-2">
                    ...
                    <Input
                      ...
                      placeholder="https://s3.yourdomain.com/assets/logo.png"
                    />
                  </div>
                  <div className="col-span-2">
                    <label className="block text-sm font-medium mb-1">
          ...
          {activeTab === "email" && (
            <Card className="shadow-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Configure your SMTP server to send documents to clients
                  directly from QManager.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
          ...
          {activeTab === "ai" && (
            <Card className="shadow-sm border-purple-100 bg-purple-50/50">
              <CardHeader>
                ...
                <CardDescription>
                  Configure AI capabilities for document generation.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="bg-white p-4 rounded-md border text-sm text-gray-600 mb-4">
                  AI functionalities are currently disabled. You will need to
                  provide an OpenAI API key or configure a custom local LLM
                  endpoint before these features become available in the
                  Quotation Builder.
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">

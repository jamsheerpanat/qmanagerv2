...
function StatusPill({ status }: { status: string }) {
  return (
    <span
      className={STATUS_CLASS[status] || "status-draft"}
      style={{
        fontSize: "11px",
        fontWeight: "600",
        padding: "3px 10px",
          ...
          {[0, 1, 2].map((i) => (
            <div
              ...
              style={{
                ...
                borderRadius: "50%",
                background: "#1a56db",
                animation: `fadeInUp 0.6s ${i * 0.15}s ease both`,
              }}
            />
          ))}
        </div>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      >
        ...
        <KpiCard
          ...
          value={fmt(kpis?.quotations?.total)}
          sub={`${kpis?.quotations?.draft || 0} drafts pending`}
          icon={FileText}
          color="purple"
          trend={12}
          delay={100}
        ...
        <KpiCard
          ...
          value={fmtCurrency(kpis?.quotations?.value)}
          sub="Open quotation value"
          icon={TrendingUp}
          color="cyan"
          trend={5}
          delay={150}
        ...
        <KpiCard
          ...
          value={fmtCurrency(kpis?.invoices?.totalValue)}
        ...
        <KpiCard
          ...
          value={fmtCurrency(kpis?.invoices?.paid)}
        ...
        <KpiCard
          ...
          value={fmtCurrency(kpis?.invoices?.overdue)}
        ...
        >
          ...
          {charts?.quotationStatusChart?.length > 0 ? (
            <ResponsiveContainer width="100%" height={220}>
              <PieChart>
                <Pie
                  data={charts.quotationStatusChart}
                  cx="50%"
                  cy="50%"
                  innerRadius={55}
                  outerRadius={85}
        ...
        >
          ...
          >
            ...
            {[
              {
                label: "Outstanding",
                value: fmtCurrency(kpis?.invoices?.outstanding),
                color: "#f59e0b",
              },
              {
                label: "Collected",

    ...
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          <div>Generating IT Infrastructure Proposal...</div>
        </div>
      </div>
    );
  if (!data) return null;
...
function getSampleData(docId: string) {
  ...
  return {
    ...
    deliveryTimeline:
      "Estimated 4–6 weeks from order confirmation and advance payment receipt.",
    terms: [],
    items: [
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "1. FIREWALL & SECURITY",
        sortOrder: 1,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Fortinet FortiGate 100F Firewall",
        description:
          "Next-gen firewall. 1Gbps throughput, IPS, web filtering, VPN. 1-yr UTM license included.",
        brand: "Fortinet",
        quantity: 1,
        unit: "Nos",
        unitPrice: 3200,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Fortinet FortiAP 431G Wi-Fi AP",
        description:
          "Wi-Fi 6 access point, managed by FortiGate. Indoor ceiling mount.",
        brand: "Fortinet",
        quantity: 8,
        unit: "Nos",
        unitPrice: 320,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "2. NETWORK SWITCHING",
        sortOrder: 4,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Cisco Catalyst 9200L-24P Core Switch",
        description:
          "24-port PoE L3 managed switch, 4x10G uplinks. Core layer.",
        brand: "Cisco",
        quantity: 1,
        unit: "Nos",
        unitPrice: 2800,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Cisco Catalyst 9200L-24T Access Switch",
        description: "24-port managed access switch. Floor-wise distribution.",
        brand: "Cisco",
        quantity: 3,
        unit: "Nos",
        unitPrice: 1400,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "3. STRUCTURED CABLING",
        sortOrder: 7,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Cat6A UTP Cabling (per point)",
        description:
          "Cat6A structured cabling, faceplate, patch panel termination, cable test report.",
        brand: "Panduit",
        quantity: 60,
        unit: "Points",
        unitPrice: 45,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: '19" Network Rack — 24U',
        description:
          '19" floor-standing rack, 24U, with power distribution, cable managers, and blanks.',
        brand: "Legrand",
        quantity: 2,
        unit: "Nos",
        unitPrice: 380,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "4. SERVER & STORAGE",
        sortOrder: 10,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "HPE ProLiant ML350 Gen11 Server",
        description:
          "Tower server, Xeon Silver 4410Y, 32GB RAM, 2x 1.2TB SAS. OS not included.",
        brand: "HPE",
        quantity: 1,
        unit: "Nos",
        unitPrice: 4200,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Synology RS1221+ NAS (8-bay)",
        description:
          "8-bay rackmount NAS. 4x 4TB IronWolf drives. Backup and file sharing.",
        brand: "Synology",
        quantity: 1,
        unit: "Nos",
        unitPrice: 1800,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "5. IMPLEMENTATION",
        sortOrder: 13,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Network Configuration & Commissioning",
        description:
          "Firewall, switch VLAN, routing, Wi-Fi, VPN configuration and testing.",
        brand: "Octonics",
        quantity: 1,
        unit: "Lot",
        unitPrice: 1200,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Server & NAS Setup",
        description:
          "OS installation, shares, permissions, backup jobs, server hardening.",
        brand: "Octonics",
        quantity: 1,
        unit: "Lot",
        unitPrice: 800,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Documentation & Handover",
        description:
          "Network diagram, IP plan, credentials doc, rack diagram, and user handover.",
        brand: "Octonics",
        quantity: 1,
        unit: "Lot",
        unitPrice: 350,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Annual IT Support Contract",
        description:
          "12-month support contract — remote and on-site. Quarterly health checks.",
        brand: "Octonics",
        quantity: 1,
        unit: "Year",
        unitPrice: 2400,

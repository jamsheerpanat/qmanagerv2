    ...
    items: [
      {
        ...
        sectionTitle: "1. LIGHTING AUTOMATION",
        sortOrder: 1,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "KNX Dimmer Actuator — 4CH",
        description:
          "4-channel dimmer actuator for lighting control. DIN rail mounted.",
        brand: "Schneider",
        quantity: 6,
        unit: "Nos",
        unitPrice: 320,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "DALI Gateway — 64 devices",
        description:
          "KNX to DALI gateway for advanced lighting protocol integration.",
        brand: "Schneider",
        quantity: 2,
        unit: "Nos",
        unitPrice: 680,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "KNX Push-button Interface 6-gang",
        description:
          "Flush-mounted 6-gang KNX push button with LED status indicator.",
        brand: "ABB",
        quantity: 12,
        unit: "Nos",
        unitPrice: 190,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "2. CURTAIN AUTOMATION",
        sortOrder: 5,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "KNX Blind Actuator — 4CH",
        description:
          "4-channel blind/curtain actuator for motorized curtain control.",
        brand: "Schneider",
        quantity: 4,
        unit: "Nos",
        unitPrice: 295,
      ...
      },
      {
        ...
        description:
          "Multi-protocol AC gateway — KNX, BACnet, Modbus integration.",
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "4. CONTROL INTERFACES",
        sortOrder: 9,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "RTI Control Processor XP-8v",
        description: "Central control processor for RTI visualization system.",
        brand: "RTI",
        quantity: 1,
        unit: "Nos",
        unitPrice: 2400,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: 'RTI In-Wall Touch Panel 7"',
        description:
          "7-inch in-wall touch panel for room-wise control dashboard.",
        brand: "RTI",
        quantity: 4,
        unit: "Nos",
        unitPrice: 980,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "5. PROGRAMMING & COMMISSIONING",
        sortOrder: 12,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "KNX System Programming",
        description:
          "Full KNX ETS programming, scene configuration, group addressing.",
        brand: "Octonics",
        quantity: 1,
        unit: "Lot",
        unitPrice: 4500,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "RTI Interface Design & Programming",
        description:
          "Custom room UI design, floor plan integration, scene buttons.",
        brand: "Octonics",
        quantity: 1,
        unit: "Lot",
        unitPrice: 2800,
      ...
      },
      {
        ...
        description:
          "Full system testing, tuning, and user handover training session.",
        brand: "Octonics",
        quantity: 1,
        unit: "Lot",
        unitPrice: 1290,
      ...
      },
      {
        ...
        description:
          "Mobile app configuration for iOS & Android with remote access.",
        brand: "Octonics",
        quantity: 1,
        unit: "Lot",
        unitPrice: 0,

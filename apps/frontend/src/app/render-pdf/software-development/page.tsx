    ...
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          <div>Generating Software Proposal...</div>
        </div>
      </div>
    );
  if (!data) return null;
...
function transformQuotation(q: any, docId: string) {
  ...
  const find = (kw: string) =>
    terms.find((t: any) => t.category?.name?.toLowerCase().includes(kw))
      ?.content;
  return {
    ...
    items: [
      {
        ...
        sectionTitle: "1. REQUIREMENT ANALYSIS & UI/UX DESIGN",
        sortOrder: 1,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Requirement Analysis & Documentation",
        description:
          "Full business requirement review, workflow mapping, user stories, and project specification document.",
        brand: "Web",
        quantity: 1,
        unit: "Lot",
        unitPrice: 800,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "UI/UX Design — Web & Mobile",
        description:
          "High-fidelity Figma designs for all web modules and mobile screens. Design system included.",
        brand: "Web",
        quantity: 1,
        unit: "Lot",
        unitPrice: 1200,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "2. WEB APPLICATION (BACKEND + FRONTEND)",
        sortOrder: 4,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Backend API Development (NestJS)",
        description:
          "REST API with JWT auth, role management, business logic, and PostgreSQL database.",
        brand: "Web",
        quantity: 1,
        unit: "Lot",
        unitPrice: 3500,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Frontend Web Application (Next.js)",
        description:
          "Responsive web app with dashboard, all CRUD modules, reports, and PDF export.",
        brand: "Web",
        quantity: 1,
        unit: "Lot",
        unitPrice: 3000,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "3. BUSINESS MODULES",
        sortOrder: 7,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Quotation & Invoice Management Module",
        description:
          "Full quotation lifecycle, revision tracking, approval workflows, PDF generation, and email sending.",
        brand: "Module",
        quantity: 1,
        unit: "Lot",
        unitPrice: 2200,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Customer & CRM Module",
        description:
          "Customer database, contact management, lead tracking, follow-up reminders, and pipeline view.",
        brand: "Module",
        quantity: 1,
        unit: "Lot",
        unitPrice: 1500,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Product & Inventory Management Module",
        description:
          "Product catalog, stock management, purchase orders, and inventory movement tracking.",
        brand: "Module",
        quantity: 1,
        unit: "Lot",
        unitPrice: 1600,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Reports & Dashboard Module",
        description:
          "Management dashboard with KPIs, sales reports, customer reports, and Excel/PDF export.",
        brand: "Module",
        quantity: 1,
        unit: "Lot",
        unitPrice: 1000,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "4. DEPLOYMENT & HANDOVER",
        sortOrder: 12,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Cloud Deployment & Configuration",
        description:
          "Application deployment on VPS/cloud, domain configuration, SSL certificate setup.",
        brand: "DevOps",
        quantity: 1,
        unit: "Lot",
        unitPrice: 500,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Testing, Bug Fixing & UAT Support",
        description:
          "Complete QA testing, bug fixing, and user acceptance testing support.",
        brand: "QA",
        quantity: 1,
        unit: "Lot",
        unitPrice: 700,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Training & System Handover",
        description:
          "User training sessions, admin training, and basic system documentation.",
        brand: "Support",
        quantity: 1,
        unit: "Lot",
        unitPrice: 500,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "React Native Mobile App (iOS + Android)",
        description:
          "Cross-platform mobile app with login, dashboard, quotation view, and customer self-service.",
        brand: "Mobile",
        quantity: 1,
        unit: "Lot",
        unitPrice: 4000,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Annual Maintenance & Support Contract",
        description:
          "12-month post-deployment support, bug fixes, and minor enhancements.",
        brand: "Support",
        quantity: 1,
        unit: "Year",
        unitPrice: 2400,

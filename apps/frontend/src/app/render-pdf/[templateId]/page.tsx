...
const getTemplateData = (templateId: string) => {
  if (templateId === "smart-home") {
    return {
      ...
      terms: [
        { title: "1. Scope of Work", content: "The Contractor shall provide all necessary labor, materials, tools, and equipment to complete the Smart Home Integration as described in this proposal." },

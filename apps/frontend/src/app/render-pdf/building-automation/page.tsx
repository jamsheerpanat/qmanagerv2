    ...
    items: [
      {
        ...
        sectionTitle: "1. BMS CONTROLLER & BACKBONE",
        sortOrder: 1,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "KNX IP Router",
        description:
          "KNX IP router for BACnet / KNX integration backbone. DIN rail mount.",
        brand: "Schneider",
        quantity: 2,
        unit: "Nos",
        unitPrice: 850,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "BMS Central Software License",
        description:
          "Centralized BMS monitoring and control software — 500 point license.",
        brand: "Siemens",
        quantity: 1,
        unit: "Lot",
        unitPrice: 5500,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "2. LIGHTING CONTROL",
        sortOrder: 4,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "KNX Switch Actuator — 8CH",
        description:
          "8-channel switch actuator for lighting zone control. DIN mounted.",
        brand: "ABB",
        quantity: 8,
        unit: "Nos",
        unitPrice: 420,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "DALI Dimmer Gateway — 64 devices",
        description:
          "KNX-DALI gateway for DALI lighting bus. 64 addressable ballasts.",
        brand: "Schneider",
        quantity: 4,
        unit: "Nos",
        unitPrice: 680,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "PIR Presence Sensor — Ceiling Mount",
        description:
          "KNX PIR presence sensor for occupancy-based lighting control.",
        brand: "ABB",
        quantity: 24,
        unit: "Nos",
        unitPrice: 95,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "3. HVAC AUTOMATION",
        sortOrder: 8,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "CoolMaster AC Gateway",
        description:
          "Multi-protocol AC gateway — KNX, BACnet, Modbus. Supports 64 FCUs.",
        brand: "CoolAutomation",
        quantity: 2,
        unit: "Nos",
        unitPrice: 1200,
        discountAmount: 0,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Room Temperature Controller",
        description:
          "KNX room thermostat with setpoint and mode control. Flush-mount.",
        brand: "ABB",
        quantity: 16,
        unit: "Nos",
        unitPrice: 180,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "4. ENERGY MONITORING",
        sortOrder: 11,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Multi-function Energy Meter",
        description:
          "3-phase energy meter with Modbus RS485 for panel-wise metering.",
        brand: "Schneider",
        quantity: 6,
        unit: "Nos",
        unitPrice: 320,
      ...
      {
        itemType: "SECTION_HEADING",
        sectionTitle: "5. ENGINEERING & COMMISSIONING",
        sortOrder: 13,
      },
      {
        itemType: "LINE_ITEM",
        sectionTitle: "KNX ETS Programming",
        description:
          "Full KNX ETS5/6 programming, group addressing, and scene configuration.",
        brand: "Octonics",
        quantity: 1,
        unit: "Lot",
        unitPrice: 5800,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "BMS Dashboard Configuration",
        description:
          "Custom floor-plan dashboard, equipment widgets, alarm configuration.",
        brand: "Octonics",
        quantity: 1,
        unit: "Lot",
        unitPrice: 3800,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Testing, Commissioning & Training",
        description:
          "Full system testing, punch-list resolution, and facility team handover.",
        brand: "Octonics",
        quantity: 1,
        unit: "Lot",
        unitPrice: 2640,
      ...
      {
        itemType: "LINE_ITEM",
        sectionTitle: "Extended Maintenance Contract (1yr)",
        description:
          "Annual preventive maintenance and remote support contract.",
        brand: "Octonics",
        quantity: 1,
        unit: "Year",
        unitPrice: 3500,

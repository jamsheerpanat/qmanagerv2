...
async function main() {
  console.log('Seeding Comprehensive Terms & Conditions Master...');
  ...
  console.log(`Terms & Conditions Master seeded successfully! Added/Updated ${addedCount} templates across ${categories.length} categories and ${groups.length} groups.`);
}
